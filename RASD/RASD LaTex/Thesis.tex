...
\usepackage{colortbl}
\usepackage{longtable} % added by Simone
\usepackage{lscape} % added by Simone
\usepackage{geometry} % added by Simone
\usepackage{multicol} % added by Simone
\usepackage{array} % added by Simone
...
\input{Chapter_2.tex} % Overall Description
\input{Chapter_3.tex} % Specific Requirements
\input{Chapter_4.tex} % Alloy
\input{Chapter_5.tex} % Effort Spent
\input{Chapter_6.tex} % References
\input{Per_fare_prove.tex}
