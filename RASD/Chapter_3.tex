...
\begin{figure} [H]
    \centering
    \includegraphics [width=.7\linewidth] {User_Interfaces/login.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.7\linewidth] {User_Interfaces/internshipBrowsing.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.7\linewidth] {User_Interfaces/studentProfile.png}
\end{figure}
\begin{figure} [H]
    \centering
    \includegraphics [width=.7\linewidth] {User_Interfaces/companyProfile.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.7\linewidth] {User_Interfaces/internshipCreationForm.png}
\end{figure}
\begin{figure} [H]
    \centering
    \includegraphics [width=.7\linewidth] {User_Interfaces/questionnaire.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=1\linewidth] {UseCaseDiagram.png}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.7\linewidth] {Use_Cases/UC1.png}
    \caption{Student Login}
\end{figure}

\begin{figure} [H]
    \centering
    \includegraphics [width=.7\linewidth] {Use_Cases/UC2.png}
    \caption{Company Login}
\end{figure}

\begin{figure} [H]
    \centering
    \includegraphics [width=.7\linewidth] {Use_Cases/UC3.png}
...
\begin{figure} [H]
    ...
    \includegraphics [width=.7\linewidth] {Use_Cases/UC4.png}
    \caption{Upload CV}
\end{figure}
...
\begin{figure} [H]
    ...
    \includegraphics [width=.7\linewidth] {Use_Cases/UC5.png}
...
\begin{figure} [H]
    ...
    \includegraphics [width=.7\linewidth] {Use_Cases/UC6.png}
...
\begin{figure} [H]
    ...
    \includegraphics [width=.7\linewidth] {Use_Cases/UC7.png}
...
\begin{figure} [H]
    ...
    \includegraphics [width=.7\linewidth] {Use_Cases/UC8.png}
...
\begin{figure} [H]
    ...
    \includegraphics [width=.7\linewidth] {Use_Cases/UC9.png}
    \caption{Communicate}
\end{figure}
...
\begin{figure} [H]
    ...
    \includegraphics [width=.7\linewidth] {Use_Cases/UC10.png}
...
\begin{figure} [H]
    ...
    \includegraphics [width=.7\linewidth] {Use_Cases/UC11.png}
...
\begin{figure} [H]
    ...
    \includegraphics [width=.7\linewidth] {Use_Cases/UC12.png}
...
\begin{figure} [H]
    ...
    \includegraphics [width=.7\linewidth] {Use_Cases/UC13.png}
...
\begin{figure} [H]
    ...
    \includegraphics [width=.7\linewidth] {Use_Cases/UC14.png}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.7\linewidth] {Activity_Diagrams/actdiagram.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.7\linewidth] {Activity_Diagrams/actdiagram.drawio.png}
\end{figure}
