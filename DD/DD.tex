...
\input{Chapter_2.tex} % Architectural Design
\input{Chapter_3.tex} % User Interface Design
\input{Chapter_4.tex} % Requirements Traceability
\input{Chapter_5.tex} % Implementation, Integration and Test plan
\input{Chapter_6.tex} % Effort Spent
\input{Chapter_7.tex} % References
\input{Chapter_8.tex} % Updated Version
