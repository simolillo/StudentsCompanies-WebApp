...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Architectural_Design/a1.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=1\linewidth] {Architectural_Design/a2.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Architectural_Design/a3.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Architectural_Design/a4.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Architectural_Design/a5.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Architectural_Design/a6.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Architectural_Design/a7.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Architectural_Design/a8.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Architectural_Design/a9.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Run_Time_Views/uc1.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Run_Time_Views/uc2.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Run_Time_Views/uc3.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Run_Time_Views/uc4.png}
\end{figure}
...
The Upload CV process begins when the Student sends their CV to the Gateway Manager through the uploadCV(CV) request. The Gateway Manager forwards this request, along with the CV and Student information, to the Student Manager. The Student Manager then sends a StoreCV(Student, CV) command to the DBMS to store the CV in the database. Once the DBMS successfully stores the CV, it sends an "ACK" message to the Student Manager to confirm the storage operation.
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Run_Time_Views/uc5.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=1\linewidth] {Run_Time_Views/uc6.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Run_Time_Views/uc7.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=1\linewidth] {Run_Time_Views/uc8.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=1\linewidth] {Run_Time_Views/uc9.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Run_Time_Views/uc10_1.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Run_Time_Views/uc10_2.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=.8\linewidth] {Run_Time_Views/uc11.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=1\linewidth] {Run_Time_Views/uc12.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=1\linewidth] {Run_Time_Views/uc13.png}
\end{figure}
...
\begin{figure} [H]
    \centering
    \includegraphics [width=1\linewidth] {Run_Time_Views/uc14.png}
\end{figure}
